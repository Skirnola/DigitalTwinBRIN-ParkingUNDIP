...
cred = credentials.Certificate("C:/Users/KATANA/OneDrive/Documents/Magang BRIN/digitaltwinparkingbrin-firebase-adminsdk-fbsvc-e22cb84455.json")  # Ganti path ini
...
def checkParkingSpaceYOLO(img, posList, model):
    ...
    for id, x, y in posList:
        ...
        db.reference(f'slot_{id}').set(status)
